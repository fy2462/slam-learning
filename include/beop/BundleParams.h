...
namespace slam {
    ...
    BundleParams::BundleParams(int argc, char **argv) {
        ...
        arg.param("initial_ply", initial_ply, "./output/initial.ply", "Export the BAL file data as a PLY file.");
        arg.param("final_ply", final_ply, "./output/final.ply", "Export the refined BAL file data as a PLY");
